...
while global_step < total_steps:
    ...
    #print('pred_seq',pred_seq[0].shape)
    #print(idx2char)
    #print(pred_seq.numpy().shape)
    pred_seq_indexes = [np.argmax(s.detach().numpy(), axis=1) for s in pred_seq]
    ...
    #        for element in pred_seq_sentences:
    #            #print(element)
    #            f.write(element)
    #            f.write('\n')
    #
